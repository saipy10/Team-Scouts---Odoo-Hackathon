        ...
        <div className="container mx-auto px-4 py-8 max-w-2xl">
          <Card>
            <CardHeader>
              ...
              <p className="text-gray-600 dark:text-gray-300">Add your pre-loved clothing to the ReWear community.</p>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                {/* Images */}
                <div className="space-y-4">
                  <Label className="text-base font-medium">Photos (up to 5)</Label>
                ...
                <div className="pt-6">
                  ...
                  <p className="text-sm text-gray-600 text-center mt-2">
                    Your item will be reviewed before going live (usually within 24 hours)
                  </p>
                </div>
              </form>
            </CardContent>
