        ...
        <header className="border-b bg-white/80 backdrop-blur-sm dark:bg-gray-900/80">
          <div className="container mx-auto px-4 py-4 flex items-center justify-between">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold text-green-800 dark:text-green-400">ReWear</span>
            </Link>
          </div>
        </header>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Have questions about ReWear? Need help with a swap? We're here to help you make sustainable fashion
              choices.
            </p>
          </div>
            ...
            <div className="lg:col-span-1 space-y-6">
              <Card>
                ...
                <CardContent>
                  ...
                  <a href="mailto:hello@rewear.com" className="text-green-600 hover:text-green-700 font-medium">
                    hello@rewear.com
                  </a>
                  <p className="text-gray-600 dark:text-gray-300 mb-2 mt-4">Support</p>
                  <a href="mailto:support@rewear.com" className="text-green-600 hover:text-green-700 font-medium">
                    support@rewear.com
                  </a>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <a href="tel:+1-555-REWEAR" className="text-green-600 hover:text-green-700 font-medium">
                    +1 (555) REWEAR
                  </a>
                </CardContent>
              </Card>
